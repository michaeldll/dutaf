...
<div class="row">
  ...
  <div class="col-md-2 text-center">
    <form action="valide_new_art.php" method="get" id="newArt">
      <div class="form-group">
        <label for='description'>Description : </label>
        <input type="text" class="form-control" name="descInput" id="titre" value="">
      </div>
      <div class="form-group">
        <label for='designation'>Designation : </label>
        <input type="text" name="desiInput" class="form-control" id="desi" value="">
      </div>
      <div class="form-group">
        <label for='prix'>Prix : </label>
        <input type="number" name="prixInput" class="form-control" id="prix" value="">
      </div>
      <div class="form-group">
        <label for='quantité'>Quantité : </label>
        <input type="number" name="quaInput" class="form-control" id="qua" value="">
      </div>
      <div class="form-group">
        <label for='four'>Fournisseur : </label>
        <!-- <input type="text" name="fouInput" class="form-control" id="fou" value=""> -->
        <select name="fouInput" class="form-control" id="fou" form="newArt">
        ...
        <?php
          ...
          while ( $un_four = $exe->fetch() ){
            if( $un_four['four_num'] == $temp['_fou_num'] ){
            }
            else{
              echo '<option value"'.$un_four['fou_num'].'">'.$un_four['fou_nom'].'</option>';
            }
          }
