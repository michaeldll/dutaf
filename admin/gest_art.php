...
<head>
	...
	<style type="text/css">footer{position: relative!important;}</style>
</head>
...
<div class="container">
	<div class="row">
		<div class="col-sm-12 text-center">
			<h1>Catalogue</h1>
			<br>
			<a href="form_new_art.php" class="btn btn-success" role="button">Nouveau</a>
		...
		<div class="col-sm-12">
			...
			<table class="table"><!-- tableau -->
				...
				$requete = 'SELECT * FROM articles'; //selection données base de données
	            ...
	            <td><a href="form_modif_art.php?id='.$ligne['art_num'].'" class="btn btn-info" role="button">Modifier</a></td><td><a href="valide_sup_art.php?id='.$ligne['art_num'].'" class="btn btn-danger" role="button">Supprimer</a></td>
	            </tr>';
				}
				?>
				</tbody>
