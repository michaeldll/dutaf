...
$requete = 'SELECT *  FROM fournisseurs WHERE four_num='.$_GET['id'];
...
<div class="row">
	<div class="col-sm-12 text-center">
		<?php
			echo "<h1>Vous venez de supprimer ".$ligne['fou_nom'].".</h1>";
			$requete_2 = 'DELETE FROM fournisseurs WHERE fou_num='.$_GET['id'];
			$exe = $bdd->query($requete_2);
		?>
		<a href="gest_art.php" class="btn btn-success" role="button">Retour</a>
	</div>
</div>
</div>
<br>
